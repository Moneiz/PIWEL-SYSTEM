...
namespace hardwarecom
{
    ...
    common::uint32_t PeripheralComponentInterconnectController::Read(uint16_t bus, uint16_t device, uint16_t function,uint32_t registeroffset){
    ...
    void PeripheralComponentInterconnectController::Write(uint16_t bus, uint16_t device, uint16_t function, uint32_t registeroffset, uint32_t value){
     ...
     bool PeripheralComponentInterconnectController::DeviceHasFunction(common::uint16_t bus, common::uint16_t device){
         return Read(bus, device,0, 0x0E) & (1<<7);
     }
     
     void PeripheralComponentInterconnectController::SelectDrivers(drivers::DriverManager* driverManager, InterruptManager* interrupt){
