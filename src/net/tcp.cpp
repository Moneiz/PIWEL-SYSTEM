...
bool TransmissionControlProtocolHandler::HandleTransmissionControlProtocolMessage(TransmissionControlProtocolSocket *socket, common::uint8_t *data, common::uint16_t size) {
    return true;
}
TransmissionControlProtocolSocket::TransmissionControlProtocolSocket(
        net::TransmissionControlProtocolProvider *backend) {
...
TransmissionControlProtocolProvider::TransmissionControlProtocolProvider(net::InternetProtocolProvider *backend)
...
void TransmissionControlProtocolProvider::Send(net::TransmissionControlProtocolSocket *socket, common::uint8_t *data,
                                               common::uint16_t size, uint16_t flags) {
...
TransmissionControlProtocolSocket* TransmissionControlProtocolProvider::Connect(common::uint32_t ip, common::uint16_t port) {
    TransmissionControlProtocolSocket* socket = (TransmissionControlProtocolSocket*) MemoryManager::activeMemoryManager->malloc(
...
void TransmissionControlProtocolProvider::Disconnect(net::TransmissionControlProtocolSocket *socket) {
